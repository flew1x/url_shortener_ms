...
//
//	mockgen -source=internal/cache/url_cache.go -destination=mocks/url_cache.go -package=mocks
//
...
func (mr *MockIUrlCacheMockRecorder) GetByLongUrl(ctx, longUrl any) *gomock.Call {
...
func (mr *MockIUrlCacheMockRecorder) GetByShortUrl(ctx, shortUrl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUrlCacheMockRecorder) SetByLongUrl(ctx, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUrlCacheMockRecorder) SetByShortUrl(ctx, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
